...
namespace Pulumi.GoogleTwingate
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.GoogleTwingate.version.txt");
    ...
    internal sealed class GoogleTwingateResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public GoogleTwingateResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
